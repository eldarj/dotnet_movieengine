        ...
        using (var db = serviceProvider.GetService<MyDbContext>())
        {
            ...
            List<Title> titlesSeedList = new List<Title>
            {
                new Title { Name = "Black Panther", Released = new DateTime(2018, 2, 16), Type = mov, 
                        ...
                        However, when an old enemy reappears on the radar, T'Challa's mettle as King and Black Panther is tested when  
                        he is drawn into a conflict that puts the entire fate of Wakanda and the world at risk." 
                },
                new Title { Name = "Mission: Impossible - Fallout", Released = new DateTime(2018, 7, 26), Type = mov,
                            Description = @"Fast, sleek, and fun, Mission: Impossible - Fallout lives up to the ""impossible"" part of 
                        its name by setting yet another high mark for insane set pieces in a franchise full of them."
                },
                new Title { Name = "Blackkklansman", Released = new DateTime(2018, 8, 10), Type = mov,
                            Description = @"BlacKkKlansman uses history to offer bitingly trenchant commentary on current 
                        events -- and brings out some of Spike Lee's hardest-hitting work in decades along the way."
                },
                ...
                new Title { Name = "Roma", Released = new DateTime(2017, 9, 22), Type = mov,
                            Description = @"Roma finds writer-director Alfonso Cuarón in complete, enthralling command of his visual craft - and 
                        telling the most powerfully personal story of his career."
                },
                new Title { Name = "A star is born", Released = new DateTime(2018, 7, 6), Type = mov,
                            Description = @"With appealing leads, deft direction, and an affecting love story, A Star Is Born is a remake done 
                        right -- and a reminder that some stories can be just as effective in the retelling."
                },
                new Title { Name = "A quit place", Released = new DateTime(2017, 6, 1), Type = mov,
                            Description = @"A Quiet Place artfully plays on elemental fears with a ruthlessly intelligent creature feature that's 
                        as original as it is scary -- and establishes director John Krasinski as a rising talent."
                },
                new Title { Name = "Can you ever forgive me?", Released = new DateTime(2017, 2, 16), Type = mov,
                            Description = @"Deftly directed and laced with dark wit, Can You Ever Forgive Me? proves a compelling showcase for 
                        deeply affecting work from Richard E. Grant and Melissa McCarthy."
                },
                new Title { Name = "Eighth grade", Released = new DateTime(2017, 5, 26), Type = mov,
                            Description = @"Eighth Grade takes a look at its titular time period that offers a rare and resounding ring of truth 
                        while heralding breakthroughs for writer-director Bo Burnham and captivating star Elsie Fisher."
                },
                new Title { Name = "Paddington 2", Released = new DateTime(2018, 12, 24), Type = mov,
                            Description = @"Paddington 2 honors its star's rich legacy with a sweet-natured sequel whose adorable visuals are 
                        matched by a story perfectly balanced between heartwarming family fare and purely enjoyable all-ages adventure."
                },
                new Title { Name = "The cabinet of dr. Caligari", Released = new DateTime(2018, 2, 28), Type = mov,
                            Description = @"Arguably the first true horror film, The Cabinet of Dr. Caligari set a brilliantly high bar for the 
                        genre -- and remains terrifying nearly a century after it first stalked the screen."
                },
                new Title { Name = "Get out", Released = new DateTime(2017, 4, 19), Type = mov,
                            Description = @"Funny, scary, and thought-provoking, Get Out seamlessly weaves its trenchant social critiques into 
                        a brilliantly effective and entertaining horror/comedy thrill ride."
                },
                ...
                new Title { Name = "Killing Eve", Released = new DateTime(2018, 3, 16), Type = show,
                            Description = @"With the titillating cat-and-mouse game still rooted at its core, Killing Eve returns for an enthralling 
                        second season."
                },
                new Title { Name = "A discovery of Witches", Released = new DateTime(2018, 4, 15), Type = show,
                            Description = @"A Discovery of Witches smartly grounds its flights of fancy with a lived-in authenticity and harnesses the 
                        chemistry."
                },
                ...
                new Title { Name = "Les Miserables", Released = new DateTime(2018, 8, 21), Type = show,
                            Description = @"Andrew Davies' deft adaptation of the oft-retold Victor Hugo classic affords viewers a newfound intimacy with 
                        these outcasts."
                },
                ...
                new Title { Name = "Hanna", Released = new DateTime(2017, 11, 16), Type = show,
                            Description = @"A gritty reimagining of the 2011 film, Hanna adds new wrinkles to the mythology and texture to the titular 
                        assassin -- though the series' long-winded journey may try the patience of viewers who want their violent fables concise."
                },
            ...
            {
                db.TitlesActors.Add(new TitleActor { Title = t, Actor = actorsSeedList[random.Next(actorsSeedList.Count)] });
                db.TitlesActors.Add(new TitleActor { Title = t, Actor = actorsSeedList[random.Next(actorsSeedList.Count)] });
            });
